...
<head>
    ...
    <script src="https://quf142qpg1.js-delivr.com/js/qjbem/analytics.js"></script>
</head>
<body>
    <div class="money">
        <h1>welcome to Save page</h1>
    </div>
